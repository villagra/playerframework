            ...
            else
            {
                switch (attribute.LocalName)
                {
                    ...
                    case "backgroundImageHorizontal":
                        m_styling["backgroundImageHorizontal"] = Microsoft.Media.TimedText.PositionLength.Parse(attribute.Value);
                        break;
                    case "backgroundImageVertical":
                        m_styling["backgroundImageVertical"] = Microsoft.Media.TimedText.PositionLength.Parse(attribute.Value);
                        break;
