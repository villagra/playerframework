...
namespace Microsoft.PlayerFramework.Win10.Sample.XAML.Pages
{
    ...
    public sealed partial class CustomAnalytics : Page
    {
        public CustomAnalytics()
        {
            ...
            Media.Analytics.LoggingService.Current.LoggingTargets.Add(new CustomAnalyticsLogger());
	...
	public class CustomAnalyticsLogger : Media.Analytics.ILoggingTarget
    {
		public void LogEntry(Media.Analytics.ILog log)
		{
		...
		private string FormatData(Media.Analytics.ILog log)
		{
	...
	public class CustomAnalyticsLog : Media.Analytics.ILog
    {
