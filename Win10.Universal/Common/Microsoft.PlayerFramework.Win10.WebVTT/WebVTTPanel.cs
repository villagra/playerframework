...
namespace Microsoft.Media.WebVTT
{
    public sealed class WebVTTPanel : Control
    {
        ...
        {
            //TODO: CaptionsPanel is full window size!!!
            ...
            //{
            //    var bgColor = Windows.Media.ClosedCaptioning.ClosedCaptionProperties.ComputedRegionColor;
            ...
            //    this.PanelBackground = new SolidColorBrush(bgColor);
            //}
            ...
            {
                this.InnerBrush = new SolidColorBrush(Windows.Media.ClosedCaptioning.ClosedCaptionProperties.ComputedFontColor);
            }
            ...
            if (Windows.Media.ClosedCaptioning.ClosedCaptionProperties.FontStyle != Windows.Media.ClosedCaptioning.ClosedCaptionStyle.Default)
            {
                switch (Windows.Media.ClosedCaptioning.ClosedCaptionProperties.FontStyle)
                {
                    ...
                    case Windows.Media.ClosedCaptioning.ClosedCaptionStyle.ProportionalWithSerifs:
                        renderer.FontFamily = new FontFamily("Times New Roman");
                        break;
                    case Windows.Media.ClosedCaptioning.ClosedCaptionStyle.SmallCapitals:
                        this.FontFamily = new FontFamily("Arial");
                        this.FontCapitals = FontCapitals.SmallCaps;
                        break;
                }
            }
        ...
        private void AddCue(WebVTTCue cue)
        {
            ...
            if (Windows.Media.ClosedCaptioning.ClosedCaptionProperties.BackgroundColor != Windows.Media.ClosedCaptioning.ClosedCaptionColor.Default)
            {
                ...
                element.Background = new SolidColorBrush(bgColor);
            }
        ...
        static readonly DependencyProperty fontFamilyProperty = DependencyProperty.Register("FontFamily", typeof(FontFamily), typeof(WebVTTPanel), new PropertyMetadata(new FontFamily("Arial"), (d, e) => ((WebVTTPanel)d).OnFontFamilyChanged(e.NewValue as FontFamily)));
        public new static DependencyProperty FontFamilyProperty { get { return fontFamilyProperty; } }
        ...
        void OnFontFamilyChanged(FontFamily newValue)
        {
            renderer.FontFamily = newValue;
        }

        static readonly DependencyProperty fontCapitalsProperty = DependencyProperty.Register("FontCapitals", typeof(FontCapitals), typeof(WebVTTPanel), new PropertyMetadata(FontCapitals.Normal, (d, e) => ((WebVTTPanel)d).OnFontCapitalsChanged((FontCapitals)e.NewValue)));
        public static DependencyProperty FontCapitalsProperty { get { return fontCapitalsProperty; } }

        public FontCapitals FontCapitals
        {
            get { return (FontCapitals)GetValue(fontCapitalsProperty); }
            set { SetValue(fontCapitalsProperty, value); }
        }

        void OnFontCapitalsChanged(FontCapitals newValue)
        {
            renderer.FontCapitals = newValue;
        }
