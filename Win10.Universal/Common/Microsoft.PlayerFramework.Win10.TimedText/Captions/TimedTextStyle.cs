...
namespace Microsoft.Media.TimedText
{
    ...
    public class TimedTextStyle
    {
        ...
        /// Default text style
        /// </summary>
        private const TextStyle DefaultTextStyle = TextStyle.None;

        private static readonly Color DefaultColor;
        private static readonly Color DefaultWindowBackgroundColor;
        private static readonly Color DefaultRegionBackgroundColor;
        ...
        private static readonly Length DefaultFontSize;
        ...
        static TimedTextStyle()
        {
            ...
            DefaultWindowBackgroundColor = Colors.Transparent;
            DefaultRegionBackgroundColor = Colors.Transparent;
            DefaultFontFamily = new FontFamily("Arial");
            DefaultFontSize = new Length
            {
        ...
        {
            WindowBackgroundColor = DefaultWindowBackgroundColor;
            RegionBackgroundColor = DefaultRegionBackgroundColor;
            Color = DefaultColor;
        ...
        /// <summary>
        /// Gets or sets the background color for the caption window.
        /// </summary>
        public Color WindowBackgroundColor { get; set; }

        /// <summary>
        /// Gets or sets the background color for the caption region.
        /// </summary>
        public Color RegionBackgroundColor { get; set; }
