...
namespace Microsoft.PlayerFramework.Advertising
{
    internal static class Extensions
    {
        ...
        public static async Task<Stream> DownloadStreamAsync(Uri source)
        {
            ...
            {
                client.UserAgent = Microsoft.Media.Advertising.Extensions.DefaultUserAgent;
            ...
            using (var client = new HttpClient())
            {
                ...
                {
                    if (Microsoft.Media.Advertising.Extensions.DefaultUserAgent != null)
                    {
                        request.Headers.UserAgent.ParseAdd(Microsoft.Media.Advertising.Extensions.DefaultUserAgent);
                    }
