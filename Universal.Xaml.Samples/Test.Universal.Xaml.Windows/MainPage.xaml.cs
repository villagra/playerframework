...
namespace Test.Universal.Xaml
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            //ButtonBehaviors.SetButtonBehavior(PlayPauseButton, player.GetMediaButtonBehavior<PlayPauseButtonBehavior>());
            //volumeButton.ViewModel = player.InteractiveViewModel;
