(function () {
    ...
    WinJS.UI.Pages.define("/pages/hub/hub.html", {
        ...
        section3HeaderNavigate: util.markSupportedForProcessing(function (args) {
            nav.navigate("/pages/common/progressive/progressive.html", { title: args.detail.section.header, groupKey: section3Group.key });
        }),
        ...
        section3ItemNavigate: util.markSupportedForProcessing(function (args) {
            ...
            nav.navigate("/pages/common/progressive/progressive.html", { item: item });
        }),
