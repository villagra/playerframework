...
namespace Microsoft.Media.Analytics
{
    ...
    /// </summary>
#if SILVERLIGHT
    public class CurrentBitrateChangedEventArgs : EventArgs
#else
    ...
    /// </summary>
#if SILVERLIGHT
    public sealed class ChunkDownloadedEventArgs : EventArgs
#else
    ...
    /// </summary>
#if SILVERLIGHT
    public sealed class ChunkFailureEventArgs : EventArgs
#else
