...
namespace Microsoft.PlayerFramework.Design.Common
{
	public class MetadataRegistrationBase
	{
				...
				try
				{
						...
						name.StartsWith("P:", StringComparison.OrdinalIgnoreCase))
					{
						...
						if (t != null && t.IsPublic && t.IsClass &&
                            t.IsSubclassOf(Microsoft.PlayerFramework.Design.Types.PlatformTypes.DependencyObjectType))
						{
		...
		{
			var attrs = t.GetCustomAttributes(Microsoft.PlayerFramework.Design.Types.PlatformTypes.EditorBrowsableAttributeType, false);
