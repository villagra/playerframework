...
namespace Microsoft.PlayerFramework.Samples
{
    public partial class MainPage : Page
    {
        ...
        List<Scenario> scenarios = new List<Scenario>
        {
            ...
            new Scenario() {Title = "Smooth streaming video", Description = "Demonstrates basic playback of the Smooth format.", ClassType = typeof(SmoothPage) },
            ...
            new Scenario() {Title = "Windows 10 Casting", Description = "Demonstrates cast to another device in Windows 10.", ClassType = typeof(Advanced.CastingPage) },
