...
copy ..\Lib\Portable\ZLib\bin\Release\ZLib.dll																															Microsoft.PlayerFramework.Js.Analytics\References\CommonConfiguration\neutral\
