(function () {
    ...
    WinJS.UI.Pages.define("/pages/itemdetail/adaptive/dash/dash.html", {
        ...
        ready: function (element, options) {
            ...
            WinJS.Binding.processAll(element, item).done(function () {
                ...
                mediaPlayer.src = "http://origintest.cloudapp.net/media/SintelTrailer_Smooth_from_WAME/sintel_trailer-1080p.ism/manifest(format=mpd-time-csf)";
