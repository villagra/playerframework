...
namespace Microsoft.PlayerFramework.Advertising
{
    ...
    public partial class MastSchedulerPlugin : PluginBase
    {
        ...
        protected override void OnUpdate()
        {
            CancelActiveTriggers();
            mainsail.Clear();
            Source = MastScheduler.GetSource((DependencyObject)CurrentMediaSource).AbsoluteUri;
            base.OnUpdate();
        }
        ...
        async void mediaPlayer_MediaLoading(object sender, MediaPlayerDeferrableEventArgs e)
        {
            if (IsEnabled)
            {
                if (Source != null)
                {
                    ...
                    try
                    {
                        await LoadAds(_Source, deferral.CancellationToken);
                    }
                    catch { /* ignore */ }
                    finally
                    {
        ...
        /// </summary>
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register("Source", typeof(string), typeof(MastSchedulerPlugin), null);
        ...
        public string Source
        {
            ...
            set
            {
                ...
                {
                    Uri newUri;
                    if (Uri.TryCreate(value.ToString(), UriKind.RelativeOrAbsolute, out newUri))
                    {
                        SetValue(SourceProperty, value);
                        _Source = newUri;
                        return;
                ...
                throw new ArgumentException("Not a valid uri", "Source");
            }
        }
    }
}
