    ...
    var ControlPanel = WinJS.Class.define(function (element, options) {
        ...
        _setOptions: function (options) {
            PlayerFramework.Utilities.setOptions(this, options, {
                ...
                isPlayResumeHidden: true,
                isPauseHidden: true,
                isReplayHidden: true,
                isRewindHidden: true,
                isFastForwardHidden: true,
                isSlowMotionHidden: true,
                isSkipPreviousHidden: true,
                isSkipNextHidden: true,
                isSkipBackHidden: true,
                isSkipAheadHidden: true,
                isElapsedTimeHidden: true,
                isRemainingTimeHidden: true,
                isTotalTimeHidden: true,
                isTimelineHidden: true,
                isGoLiveHidden: true,
                isCaptionsHidden: true,
                isAudioHidden: true,
                isVolumeMuteHidden: true,
                isVolumeHidden: true,
                isMuteHidden: true,
                ...
                isInfoHidden: true,
                isMoreHidden: true,
                isDisplayModeHidden: true,
                isSignalStrengthHidden: true,
                isMediaQualityHidden: true
            });
        },
