(function (PlayerFramework, undefined) {
    ...
    var InteractiveViewModel = WinJS.Class.define(function (mediaPlayer) {
        ...
        playPauseIcon: {
        	get: function () {
        		var x = this._mediaPlayer.isPlayResumeAllowed ? PlayerFramework.Utilities.getResourceString("PlayIcon") : PlayerFramework.Utilities.getResourceString("PauseIcon");
        		return x;
