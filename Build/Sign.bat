...
"%SN%" -R Win8.Xaml.Advertising\bin\x86\Release\Microsoft.VideoAdvertising.winmd								Win8.Xaml.Advertising\Microsoft.PlayerFramework.snk
"%SN%" -R Win8.Xaml.WebVTT\bin\x86\Release\Microsoft.WebVTT.winmd												Win8.Xaml.WebVTT\Microsoft.PlayerFramework.snk
...
"%SN%" -R Win8.VideoAnalytics\bin\x86\Release\Microsoft.VideoAnalytics.winmd									Win8.VideoAnalytics\Microsoft.PlayerFramework.snk
"%SN%" -R Win8.VideoAdvertising\bin\x86\Release\Microsoft.VideoAdvertising.winmd								Win8.VideoAdvertising\Microsoft.PlayerFramework.snk
"%SN%" -R Win8.Js.Analytics\bin\x86\Release\Microsoft.PlayerFramework.Js.Analytics.winmd						Win8.Js.Analytics\Microsoft.PlayerFramework.snk
"%SN%" -R Win8.Js.Advertising\bin\x86\Release\Microsoft.PlayerFramework.Js.Advertising.winmd					Win8.Js.Advertising\Microsoft.PlayerFramework.snk
